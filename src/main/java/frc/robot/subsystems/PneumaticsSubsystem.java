...
public class PneumaticsSubsystem extends SubsystemBase {
    ...
    /**
     * pistonButton(boolean b) makes the piston extend and stay extended while the
     * button is held down. when the button is released, the piston will retract.
     ...
     * <hr>
     * pistonButton is written this way (instead of just using a while loop) to stop
     * the piston from running pistonForward() 50 times a second.
     * 
     * @param b
     */
